...
func (x *IsAdminRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRequset) ProtoMessage() {}

func (x *IsAdminRequset) ProtoReflect() protoreflect.Message {
	mi := &file_sso_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRequset.ProtoReflect.Descriptor instead.
func (*IsAdminRequset) Descriptor() ([]byte, []int) {
	return file_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAdminRequset) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_sso_proto_rawDesc = "" +
	...
	"\aIsAdimn\x12\x14.auth.IsAdminRequset\x1a\x15.auth.IsAdminResponseB\x13Z\x11maks.sso.v1;ssov1b\x06proto3"
...
var file_sso_proto_goTypes = []any{
	...
	(*IsAdminRequset)(nil),   // 4: auth.IsAdminRequset
...
var file_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.IsAdimn:input_type -> auth.IsAdminRequset
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.IsAdimn:output_type -> auth.IsAdminResponse
